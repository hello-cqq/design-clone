...
| M49.1 | 09-10 | parity 选择器 tag-agnostic；存量保真债校准（新 run 硬拦/存量 warn）→ `docs/QA/parity-debt.md` | ❌ | ✅ |
...
| **M115** | 09-21 | 媒体钥匙发现链补洞+consent 机械门（exit4/5）+标准 key 解禁生图+§G 重写；LESSONS 249-250 | ✅ | ✅ CHANGELOG |
| **M114.4** | 09-20 | as/end 壳修+微信/飞书封面隐私重生成（--hero live）；LESSONS 247-248 | ✅ | ✅ CHANGELOG |
| **M114.2** | 09-19 | 飞鸟 alpha 墨片终版+embed 心跳兜底+移动修正+commit 英文规范；LESSONS 244-246 | ✅ | ✅ CHANGELOG |
...
| **M109** | 09-17 | 精修二轮：女角更少女+暗色融合/trio 演示合并飞鸟背景/手机竖屏/手写词标/站名归一；LESSONS 212-217 | ✅ | ✅ CHANGELOG |
