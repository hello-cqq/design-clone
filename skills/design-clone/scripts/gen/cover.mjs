...
${mob ? `<rect x="${FX + FW / 2 - 40}" y="${FY + 14}" width="80" height="12" rx="6" fill="#4a3b2e" opacity=".18"/>` : `<g fill="#4a3b2e" opacity=".25"><circle cx="${FX + 22}" cy="${FY + 18}" r="4"/><circle cx="${FX + 38}" cy="${FY + 18}" r="4"/><circle cx="${FX + 54}" cy="${FY + 18}" r="4"/></g>`}
